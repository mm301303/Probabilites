...
public class NormaleLawTest {
    ...
    double delta = 0.2;//La précision de ma loi normale...
    ...
    public void exo10TD2() throws CalculationException {
        ...
        double res = law.F(-10./36.);//Avec La NCRL ca marche
        System.out.println("res = " + res);
        assertEquals(0.4746,res, delta);
    ...
    public void exo11TD2() throws CalculationException {
        ...
        NormaleCenteredReducedLaw law = new NormaleCenteredReducedLaw();
        double res1 =  law.F_de_p_superieur_a(-3./16);
        ...
        assertEquals(69.146/100,res1,delta);
        assertEquals(0.69146,res1,delta);
        assertEquals(0.1708,res20,delta);
